...
#ifndef __GreTest__S15ShowVideo__
#define __GreTest__S15ShowVideo__
...
class S15ShowVideo : public S1JinRiShangPin, public CCScrollViewDelegate
{
public:
    static CCScene* scene();
    virtual bool initInfo2();
    virtual bool setUpSubClass2();
    CREATE_FUNC(S15ShowVideo);
...
#endif /* defined(__GreTest__S15ShowVideo__) */
