...
#define classPlistName_macro "S35ShowVideo"
#define zNum 100
#define btnTag 100

CCScene* S35ShowVideo::scene()
{
	CCScene * scene = NULL;
	do
	{
		scene = CCScene::create();
		S35ShowVideo *layer = S35ShowVideo::create();
...
void S35ShowVideo::refreshDownLoadingData(bool isCompleted)
{
...
void S35ShowVideo::DownLoadFinish()
{
...
bool S35ShowVideo::setUpSubClass2()
{
	bool bRet = false;
	do
	{
        ...
        
        {
            ...
            CCMenuItemImage * aItemImage = CCMenuItemImage::create(str.c_str(),
                                                                   str.c_str(),
                                                                   this,
                                                                   menu_selector(S35ShowVideo::S15DetailCallback));
...
//                    CCLOG("aaaaa%s",str.c_str());
            ...
            if(i==0){
                const char * imageName = "S35ScrollBigPic1.png";//showBigPicMap[PersonalApi::convertIntToString(i+1)].c_str();
...
void S35ShowVideo::S15DetailCallback(CCObject* pSender)
{
    if (isMenuLock == false)
    {
...
void S35ShowVideo::scrollViewDidScroll(CCScrollView* view)
{
    isMenuLock = true;
    this->schedule(schedule_selector(S35ShowVideo::S31Delay),0.5f);
}

void S35ShowVideo::S31Delay(float dt)
{
    isMenuLock = false;
}
