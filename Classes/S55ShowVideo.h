...
#ifndef __GreTest__S55ShowVideo__
#define __GreTest__S55ShowVideo__
...
class S55ShowVideo : public S5DingGou, public CCScrollViewDelegate
{
public:
    static CCScene* scene();
    virtual bool initInfo2();
    virtual bool setUpSubClass2();
    CREATE_FUNC(S55ShowVideo);
...
#endif /* defined(__GreTest__S55ShowVideo__) */
