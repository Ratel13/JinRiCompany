...
#define classPlistName_macro "S65ShowVideo"
#define zNum 100
#define btnTag 100

CCScene* S65ShowVideo::scene()
{
	CCScene * scene = NULL;
	do
	{
		scene = CCScene::create();
		S65ShowVideo *layer = S65ShowVideo::create();
...
void S65ShowVideo::scrollViewDidScroll(CCScrollView* view)
{
    isMenuLock = true;
    this->schedule(schedule_selector(S65ShowVideo::S31Delay),0.5f);
}

void S65ShowVideo::S31Delay(float dt)
{
    isMenuLock = false;
}
