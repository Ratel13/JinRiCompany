...
#ifndef __jinRiCompany__S61Detail__
#define __jinRiCompany__S61Detail__
...
class S61Detail : public S6PeiXun, public CCScrollViewDelegate,public CCEditBoxDelegate
{
public:
    static CCScene* scene();
    virtual bool initInfo2();
    virtual bool setUpSubClass2();
    CREATE_FUNC(S61Detail);
private:
...
#endif /* defined(__jinRiCompany__S61Detail__) */
